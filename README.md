...
* Section 4 - Structuring Apps with Class-Based Components (Completed **Seasons project will be completed in Section 5**)
* Section 5 - Refactoring from Functional to Class Components (In Progress)
